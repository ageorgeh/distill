...
export const CONTEXT_SCHEMA = {
  ...
  properties: {
    ...
    intent: {
      ...
      description: "Choose implement when code or configuration will change; advise for read-only investigation, diagnosis, or explanation of existing behavior; review only when the actual base-to-HEAD branch or PR changeset is the subject; merge only when unmerged conflicts are the subject.",
    },
